...
EMAIL_HOST_USER = 'ibrahime.chaine@gmail.com' # remplacer avec votre adresse email
EMAIL_HOST_PASSWORD = 'wgvt fsvz ivzl homd' # remplacer avec votre mot de passe email
